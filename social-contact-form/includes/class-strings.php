...
class Strings {
	...
	public static function get() {
		return [
			...
			'insert'             => __( 'Insert', 'social-contact-form' ),
			...
			'whatsapp_destination' => __( 'Send to', 'social-contact-form' ),
			'whatsapp_group'     => __( 'WhatsApp Group', 'social-contact-form' ),
			'whatsapp_number_hint' => __( 'Send messages to any phone number.', 'social-contact-form' ),
			'whatsapp_group_hint' => __( 'Send messages to a WhatsApp group.', 'social-contact-form' ),
			'whatsapp_number_url_label' => __( 'WhatsApp Number', 'social-contact-form' ),
			'whatsapp_number_input_hint' => __( 'Enter your WhatsApp number with country code', 'social-contact-form' ),
			'whatsapp_group_url_label' => __( 'WhatsApp Group URL or Code', 'social-contact-form' ),
			'whatsapp_group_invite_placeholder' => __( 'Paste group invite link or code (e.g. https://chat.whatsapp.com/ABC123)', 'social-contact-form' ),
			'whatsapp_group_invite_hint' => __( 'Paste the full WhatsApp group invite URL or just the invite code', 'social-contact-form' ),
			'send_message_to_whatsapp_section' => __( 'WhatsApp messaging', 'social-contact-form' ),
			'send_message_to_whatsapp' => __( 'Send message to WhatsApp', 'social-contact-form' ),
			'send_message_to_whatsapp_hint' => __( 'When enabled, visitors are redirected to WhatsApp to send the message after submit. When disabled, the lead is stored in FormyChat only—no WhatsApp redirect.', 'social-contact-form' ),
			'whatsapp_widget_display' => __( 'Choose how you prefer to display your widget', 'social-contact-form' ),
			'widget_display_single' => __( 'Single', 'social-contact-form' ),
			'widget_display_multi_agents' => __( 'Multi-agents', 'social-contact-form' ),
			'widget_display_single_hint' => __( 'Display widget for one agent.', 'social-contact-form' ),
			'widget_display_agents_hint' => __( 'Display widget for multiple agents.', 'social-contact-form' ),
			...
			'exclude_posts' => __( 'Exclude posts', 'social-contact-form' ),
			'exclude_all_posts_except' => __( 'Exclude all posts excepts:', 'social-contact-form' ),
			...
			'untitled_post'      => __( 'Untitled Post', 'social-contact-form' ),
			...
			'ultimate'           => __( 'Ultimate', 'social-contact-form' ),
			'new'                => __( 'New', 'social-contact-form' ),
			...
			'select_pages'       => __( 'Select pages', 'social-contact-form' ),
			'select_posts'       => __( 'Select posts', 'social-contact-form' ),
			'no_page_found'      => __( 'No page found', 'social-contact-form' ),
			'all_widgets'        => __( 'All Widgets', 'social-contact-form' ),
			'all_forms'          => __( 'All Forms', 'social-contact-form' ),
			...
			'select_an_option'   => __( 'Select an option', 'social-contact-form' ),
			...
			'category_all'       => __( 'All', 'social-contact-form' ),
			'category_crm_marketing' => __( 'CRM & Marketing', 'social-contact-form' ),
			'category_email_newsletters' => __( 'Email & Newsletters', 'social-contact-form' ),
			'category_automation_webhooks' => __( 'Automation & Webhooks', 'social-contact-form' ),
			'category_file_storage_cloud' => __( 'File Storage & Cloud', 'social-contact-form' ),
			'category_analytics_tracking' => __( 'Analytics & Tracking', 'social-contact-form' ),
			'category_communication' => __( 'Communication', 'social-contact-form' ),
			'category_others'    => __( 'Others', 'social-contact-form' ),
			'integration_fluentcrm_title' => __( 'FluentCRM', 'social-contact-form' ),
			'integration_fluentcrm_desc' => __( 'Connect your Form leads to FluentCRM and instantly add new contacts when a form is submitted. Perfect for automated email campaigns and segmented marketing.', 'social-contact-form' ),
			'integration_mailchimp_title' => __( 'MailChimp', 'social-contact-form' ),
			'integration_mailchimp_desc' => __( 'Create Mailchimp newsletter signups directly from your form submissions. Automatically grow your audience and engage your subscribers.', 'social-contact-form' ),
			'integration_google_sheets_title' => __( 'Google Sheets', 'social-contact-form' ),
			'integration_google_sheets_desc' => __( 'Sync form submissions directly to Google Sheets in real time. Perfect for reporting, analytics, or team collaboration without manual data entry.', 'social-contact-form' ),
			'integration_mailpoet_title' => __( 'MailPoet', 'social-contact-form' ),
			'integration_mailpoet_desc' => __( 'Add subscribers to your MailPoet mailing lists as soon as they submit a form. Automate your newsletter growth and keep your audience engaged.', 'social-contact-form' ),
			'install_uppercase'  => __( 'INSTALL', 'social-contact-form' ),
			...
			'greeting_template_simple' => __( 'Simple', 'social-contact-form' ),
			'greeting_template_wave' => __( 'Wave', 'social-contact-form' ),
			'greeting_template_whatsapp' => __( 'Whatsapp', 'social-contact-form' ),
			...
			'keyboard_shortcuts_ctrl' => __( 'Keyboard Shortcuts: CTRL/CMD + B, I, S', 'social-contact-form' ),
			...
			'custom_dropdown_field' => __( 'Dropdown field', 'social-contact-form' ),
			'custom_dropdown_hint' => __( 'Add a dropdown to the FormyChat form and use its value in the message template.', 'social-contact-form' ),
			'custom_dropdown_section_title' => __( 'Configure dropdown', 'social-contact-form' ),
			'custom_dropdown_section_tooltip' => __( 'Each setting below adds or controls one part of the dropdown on your live form. Fill them in order: label and key first, then choices. Use Insert → in the message template to add {your_key}.', 'social-contact-form' ),
			'custom_dropdown_field_label' => __( 'Field label', 'social-contact-form' ),
			'custom_dropdown_field_label_tooltip' => __( 'Shown above the dropdown on the form. Example: “Topic” or “How can we help?”. Use clear, short wording visitors will understand.', 'social-contact-form' ),
			'custom_dropdown_field_name' => __( 'Field key (for template tag)', 'social-contact-form' ),
			'custom_dropdown_field_name_tooltip' => __( 'Internal name: lowercase letters, numbers, underscores only (auto-corrected on save). Use it in the message template as {key} — e.g. {topic}. Avoid words: name, email, phone, message.', 'social-contact-form' ),
			'custom_dropdown_placeholder' => __( 'First option label (empty value)', 'social-contact-form' ),
			'custom_dropdown_placeholder_tooltip' => __( 'Optional. Creates a first row with an empty value so visitors must pick a real option. The text is what they read (e.g. “Choose one…”). Leave blank to start with the first real choice instead.', 'social-contact-form' ),
			'custom_dropdown_position' => __( 'Field position', 'social-contact-form' ),
			'custom_dropdown_position_tooltip' => __( 'Where the dropdown appears among the default fields (name, email, phone, message). Pick a spot that fits your flow — e.g. before the message for “what is this about?”.', 'social-contact-form' ),
			'custom_dropdown_position_after_name' => __( 'After name', 'social-contact-form' ),
			'custom_dropdown_position_after_email' => __( 'After email', 'social-contact-form' ),
			'custom_dropdown_position_after_phone' => __( 'After phone', 'social-contact-form' ),
			'custom_dropdown_position_before_message' => __( 'Before message', 'social-contact-form' ),
			'custom_dropdown_options' => __( 'Options', 'social-contact-form' ),
			'custom_dropdown_options_tooltip' => __( 'Each row is one menu item. Label = what the visitor sees. Stored value = what is saved and sent in WhatsApp / leads (can match the label or be a short code). Add at least one row with both filled in.', 'social-contact-form' ),
			'custom_dropdown_option_label' => __( 'Label', 'social-contact-form' ),
			'custom_dropdown_option_label_col_tooltip' => __( 'Text shown in the dropdown list for this row (e.g. “Sales inquiry”).', 'social-contact-form' ),
			'custom_dropdown_option_value' => __( 'Stored value', 'social-contact-form' ),
			'custom_dropdown_option_value_col_tooltip' => __( 'Value saved when this row is selected — appears in your message template as {field_key} and in lead data. Can match the label or use a short internal value.', 'social-contact-form' ),
			'custom_dropdown_add_option' => __( 'Add option', 'social-contact-form' ),
			'custom_dropdown_required' => __( 'Required', 'social-contact-form' ),
			'custom_dropdown_required_tooltip' => __( 'When on, visitors must choose an option before submit (empty first row does not count as a choice). Turn off if you allow skipping the dropdown.', 'social-contact-form' ),
			...
			'enable_recaptcha'   => __( 'Enable reCAPTCHA', 'social-contact-form' ),
			'recaptcha_widget_hint' => __( 'Enable reCAPTCHA for this widget to protect it from spam.', 'social-contact-form' ),
			'recaptcha_enable_for_widget' => __( 'Use reCAPTCHA on this widget', 'social-contact-form' ),
			'recaptcha_section_title' => __( 'reCAPTCHA', 'social-contact-form' ),
			'recaptcha_section_desc' => __( 'Protect your FormyChat form from spam. Get your keys from Google reCAPTCHA.', 'social-contact-form' ),
			'recaptcha_enable_hint' => __( 'Enable reCAPTCHA on the built-in FormyChat form.', 'social-contact-form' ),
			'recaptcha_setup_help' => __( 'Need keys? Register your site in Google reCAPTCHA Admin, choose v2 or v3, then paste the site key and secret key below. Full walkthrough:', 'social-contact-form' ),
			'recaptcha_setup_documentation' => __( 'Google reCAPTCHA setup documentation', 'social-contact-form' ),
			'recaptcha_version_label' => __( 'Version', 'social-contact-form' ),
			'recaptcha_version_v2' => __( 'v2 (Checkbox)', 'social-contact-form' ),
			'recaptcha_version_v3' => __( 'v3 (Invisible)', 'social-contact-form' ),
			'recaptcha_version_hint' => __( 'v2 shows a checkbox; v3 runs invisibly in the background.', 'social-contact-form' ),
			'recaptcha_version_tooltip' => __( 'reCAPTCHA v2 shows a visible checkbox challenge on the form; v3 runs invisibly and uses a risk score. Choose the same version you registered in Google reCAPTCHA Admin for this site—a mismatch will break verification.', 'social-contact-form' ),
			'recaptcha_site_key_label' => __( 'Site Key', 'social-contact-form' ),
			'recaptcha_site_key_placeholder' => __( 'Enter your site key', 'social-contact-form' ),
			'recaptcha_site_key_hint' => __( 'Public key used on the frontend.', 'social-contact-form' ),
			'recaptcha_site_key_tooltip' => __( 'Get this from Google: open Google reCAPTCHA Admin (google.com/recaptcha/admin), select your site (or register a new one). After you choose v2 or v3 and add your domains, copy the Site key shown on the key pair—paste it here.', 'social-contact-form' ),
			'recaptcha_secret_key_label' => __( 'Secret Key', 'social-contact-form' ),
			'recaptcha_secret_key_placeholder' => __( 'Leave blank to keep current', 'social-contact-form' ),
			'recaptcha_secret_key_configured' => __( 'Secret key is configured', 'social-contact-form' ),
			'recaptcha_secret_key_hint' => __( 'Secret key for server-side verification. Keep it private.', 'social-contact-form' ),
			'recaptcha_secret_key_tooltip' => __( 'In the same reCAPTCHA Admin page as your site key, copy the Secret key next to the Site key. Use it only in FormyChat (server-side)—never expose it in JavaScript, themes, or public pages.', 'social-contact-form' ),
			'enable_turnstile'   => __( 'Enable Cloudflare Turnstile', 'social-contact-form' ),
			'turnstile_enable_hint' => __( 'Use Cloudflare Turnstile on the built-in FormyChat form. Only one of reCAPTCHA or Turnstile can be active.', 'social-contact-form' ),
			'turnstile_setup_help' => __( 'Need an account or keys? Create a free Cloudflare account, open Turnstile, add a widget, then paste the site key and secret key below. Full walkthrough:', 'social-contact-form' ),
			'turnstile_setup_documentation' => __( 'Cloudflare Turnstile setup documentation', 'social-contact-form' ),
			'turnstile_site_key_label' => __( 'Site Key', 'social-contact-form' ),
			'turnstile_site_key_placeholder' => __( 'Enter your Turnstile site key', 'social-contact-form' ),
			'turnstile_site_key_hint' => __( 'Public site key from the Cloudflare Turnstile widget.', 'social-contact-form' ),
			'turnstile_site_key_tooltip' => __( 'Get this from Cloudflare: open the dashboard (dash.cloudflare.com), go to Turnstile, then add a site or open your existing widget. The Site key is shown in the widget details—copy it here.', 'social-contact-form' ),
			'turnstile_secret_key_label' => __( 'Secret Key', 'social-contact-form' ),
			'turnstile_secret_key_placeholder' => __( 'Leave blank to keep current', 'social-contact-form' ),
			'turnstile_secret_key_hint' => __( 'Secret key for server-side verification. Keep it private.', 'social-contact-form' ),
			'turnstile_secret_key_tooltip' => __( 'In the same Cloudflare Turnstile widget, open the widget settings. Reveal and copy the Secret key (not the site key). Paste it only here—FormyChat uses it on the server; never put it in theme code or public pages.', 'social-contact-form' ),
