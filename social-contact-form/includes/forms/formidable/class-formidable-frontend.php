         ...
         // phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching -- Direct query needed for Formidable Forms table.
            ...
            $data = array(
				...
				'formychat' => array(
					...
					'destination_type'     => isset($options['formychat_destination_type']) ? $options['formychat_destination_type'] : 'phone',
					'group_invite_code'    => isset($options['formychat_group_invite_code']) ? $options['formychat_group_invite_code'] : '',
					'number'               => $number,
					'message'              => isset($options['formychat_message']) ? $options['formychat_message'] : '',
					'formidable_message_template' => isset($options['formychat_message']) ? $options['formychat_message'] : '',
					'new_tab'              => isset($options['formychat_new_tab']) ? wp_validate_boolean($options['formychat_new_tab']) : 0,
					'web_version'          => isset($options['formychat_navigate_to_web']) ? wp_validate_boolean($options['formychat_navigate_to_web']) : 0,
